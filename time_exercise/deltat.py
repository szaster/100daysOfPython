...
def eatingtimer():
    ...
    if int(BG) == targetBG and GI == "low":
        dthigh = datetime.timedelta(minutes=10)
        deltahigh = now + dthigh
        print("My current BG is ", BG, "at time ", now, "I can eat right now and bolus in 10 minutes at", deltahigh)

    # BG is below target block
    if int(BG) < targetBG and GI == "high":
        dthigh = datetime.timedelta(minutes=5)
        deltahigh = now + dthigh
        print("My current BG is ", BG, "at time ", now, "I can eat in ", dthigh, "minutes at", deltahigh)
    if int(BG) < targetBG and GI == "moderate":
        dthigh = datetime.timedelta(minutes=5)
        deltahigh = now + dthigh
        print("My current BG is ", BG, "at time ", now, "I can eat right now and bolus in 5 minutes at", deltahigh)
    if int(BG) < targetBG and GI == "low":
        dthigh = datetime.timedelta(minutes=20)
        deltahigh = now + dthigh
        print("My current BG is ", BG, "at time ", now, "I can eat right now and bolus in 20 minutes at", deltahigh)
